      ...
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-2 text-sm">
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          ...
          {checkToken ? (
            ...
            <>
            <Link to="/login">
              <button className="navbar3 hidden md:block text-sm px-4 py-1 rounded-lg bg-green-500 text-white transition-transform hover:scale-105 font-bold">
                Login
              </button>
            </Link>
            <Link to="/register">
            <button className="navbar3 hidden md:flex items-center gap-1 px-4 py-1 text-sm rounded-lg bg-green-500 text-white transition-transform hover:scale-105 font-bold">
