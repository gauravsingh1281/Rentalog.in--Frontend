        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <ul className="flex flex-row lg:gap-10 md:gap-6 font-medium">
              <li>
                <a href="#home" aria-current="page" className="hover:text-xl hover transition duration-300">
                  HOME
                </a>
              </li>
              <li>
                <a href="#Service" aria-current="page" className="hover:text-xl hover transition duration-300">
                  RENTALS
                </a>
              </li>
              <li>
                <a href="#AboutUs" aria-current="page" className="hover:text-xl hover transition duration-300">
                  ABOUT
                </a>
              </li>
              <li>
                <a href="#ContactUs" aria-current="page" className="hover:text-xl hover transition duration-300">
                  CONTACT
                </a>
              </li>
            </ul>
