...
const Services = () => {
  return (
    <>
    <div id="Service"></div>
      <h1 className=" text-4xl md:text-5xl font-semibold text-[#312F2F] text-center pt-10 dark:text-darkMode-textColor">
      ...
      <div className="bg-[#D1F2EB] my-20 mb-0 dark:bg-darkMode-green">
        <h1 className="text-3xl md:text-4xl font-semibold text-[#312F2F] text-center py-10 dark:text-darkMode-textColor">
