...
const Services = () => {
  ...
  return (
    <>
<div id="Service"></div>
<h1 className="text-4xl md:text-5xl font-semibold text-transparent bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 bg-clip-text text-center pt-10">
...
>
  <h1
    className="text-3xl md:text-4xl text-transparent bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 bg-clip-text text-center py-10 font-[700]"
    style={{
  ...
  <h2
    className="font-semibold w-full text-center h-9 text-4xl"
    style={{
