...
const Testimonial = () => {
    ...
    return (
        ...
        <div className=" testimonial max-w-[1440px] h-[780px] m-auto py-16 px-4 relative group" style={{ backgroundImage: `url(${testimonialbg})` }}>
            ...
            <div className="flex justify-center items-center w-72 h-72 sm:w-96 sm:h-96 rounded-full overflow-hidden py-3 bg-center bg-cover duration-500 mx-auto">
            ...
            <div onClick={handleLeftSlide} className="lg:hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] left-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer">
                <BsChevronLeft size={30} />
            </div>
            <div onClick={handleRightSlide} className="md:block lg:hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer">
            ...
            <div className='flex top-4 justify-center py-2'>
                {slides.map((singleSlide, slideIndex) => (
                    ...
                    >
                        <RxDotFilled className={`${slideIndex === slide ? 'text-textWhite' : 'text-black'}`} />
                    </div>
                ))}
            </div>
        </div>
